...
shareable link. Your deliverable is `dist/atelier-3d-<version>.cptf`, produced by
...
npm run build                      # -> dist/atelier-3d-<version>.cptf
...
export default defineTemplate({
  slug: "atelier-3d",          // must not change
  name: "Atelier 3d",
  description: "…",
  category: "birthday",
...
`npx cutiepage build --untrusted` exits 0 and `dist/atelier-3d-<version>.cptf`
